...
from buildbot.steps import diffinfo
...
class TestDiffInfo(steps.BuildStepMixin, TestReactorMixin, unittest.TestCase):
    ...
    def test_merge_base_failure(self):
        self.setupStep(diffinfo.DiffInfo())
        self.expectCommands(
        ...
        self.expectOutcome(result=results.FAILURE, state_string="diffinfo (failure)")
        return self.runStep()
    ...
    def test_diff_failure(self):
        ...
        self.expectCommands(
            ...
            + 0,
            ExpectShell(workdir='wkdir', command=['git', 'diff', '-U0', '1234123412341234', 'HEAD'])
    ...
    def test_empty_diff(self):
        ...
        self.expect_build_data('diffinfo-master', b'[]', 'DiffInfo')
        return self.runStep()
...
''')
        ...
        diff_info = (
            ...
            b'{"source_file": "a/file2", "target_file": "b/file2", ' +
            b'"is_binary": false, "is_rename": false, ' +
            b'"hunks": [{"ss": 4, "sl": 0, "ts": 5, "tl": 3}, ' +
            b'{"ss": 15, "sl": 0, "ts": 19, "tl": 3}]}, ' +
            b'{"source_file": "/dev/null", "target_file": "b/file3", ' +
            b'"is_binary": false, "is_rename": false, ' +
            b'"hunks": [{"ss": 0, "sl": 0, "ts": 1, "tl": 3}]}]')
        self.expect_build_data('diffinfo-master', diff_info, 'DiffInfo')
        return self.runStep()
